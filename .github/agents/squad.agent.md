...
For this accounting repo, any agent that changes code, tests, workflows, or agent instructions must run `npm test` before completing the task, alongside the existing Lamdera validation steps required by the repo instructions.
