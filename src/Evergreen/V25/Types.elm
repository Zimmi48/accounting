...
type alias SubTransaction =
    { date : Maybe { year : Int, month : Int, day : Int }
    , secondaryDescription : Maybe String
...
type alias Spending =
    ...
    -- sub-transactions that can have different dates or descriptions
    , subTransactions : List SubTransaction
...
subTransactionCodec : Codec SubTransaction
subTransactionCodec =
    Codec.object SubTransaction
        |> Codec.field "date"
            .date
            (Codec.nullable
                (Codec.object (\year month day -> { year = year, month = month, day = day })
        ...
        |> Codec.field "secondaryDescription" .secondaryDescription (Codec.nullable Codec.string)
...
spendingCodec =
    Codec.object Spending
        ...
        |> Codec.field "subTransactions" .subTransactions (Codec.list subTransactionCodec)
