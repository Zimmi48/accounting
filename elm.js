...
var _Fresheyeball$elm_restrict_number$Positive$toNum = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _Fresheyeball$elm_restrict_number$Positive$Positive = function (a) {
	return {ctor: 'Positive', _0: a};
};
var _Fresheyeball$elm_restrict_number$Positive$fromNum = function (x) {
	return (_elm_lang$core$Native_Utils.cmp(x, 0) > 0) ? _elm_lang$core$Maybe$Just(
		_Fresheyeball$elm_restrict_number$Positive$Positive(x)) : _elm_lang$core$Maybe$Nothing;
};
...
var _user$project$Lib$viewDialog = F5(
...
var _user$project$Lib$successButton = F2(
...
var _user$project$Lib$selector = F6(
	function (selectName, helper, objects, updateSelect, addClasses, isRequired) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$for(selectName)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(helper)
						])),
					_elm_lang$html$Html$text(' '),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$name(selectName),
							_elm_lang$html$Html_Attributes$required(isRequired),
							_elm_lang$html$Html_Attributes$class('form-control'),
							A2(
							_elm_lang$html$Html_Events$on,
							'change',
							A2(_elm_lang$core$Json_Decode$object1, updateSelect, _elm_lang$html$Html_Events$targetValue))
						]),
					A2(
						_elm_lang$core$List$indexedMap,
						F2(
							function (i, _p1) {
								...
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$value(_p2.id),
...
var _user$project$Lib$inputGr = F4(
	function (inputName, helper, updateInput, attrs) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$for(inputName)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(helper)
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(updateInput),
								_elm_lang$html$Html_Attributes$class('form-control')
							]),
						attrs),
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$Lib$Transaction = F4(
	function (a, b, c, d) {
		return {object: a, value: b, date: c, accountId: d};
	});
var _user$project$Lib$decodeTransaction = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Lib$Transaction,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'object', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'value', _elm_lang$core$Json_Decode$float),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'date',
		A2(_elm_lang$core$Json_Decode$customDecoder, _elm_lang$core$Json_Decode$string, _elm_lang$core$Date$fromString)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'account', _elm_lang$core$Json_Decode$string));
var _user$project$Lib$Account = F3(
	function (a, b, c) {
		return {name: a, value: b, id: c};
	});
var _user$project$Lib$decodeAccount = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Lib$Account,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'value', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], '_id', _elm_lang$core$Json_Decode$string));
var _user$project$Lib$Contact = F3(
	function (a, b, c) {
		return {name: a, email: b, id: c};
	});
var _user$project$Lib$decodeContact = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Lib$Contact,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'email', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], '_id', _elm_lang$core$Json_Decode$string));

var _user$project$AddAccount$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdateName':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							name: A2(_elm_lang$core$String$left, 50, _p0._0)
						}),
			...
			case 'UpdateValue':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							initialValue: _elm_lang$core$Result$toMaybe(
								_elm_lang$core$String$toFloat(_p0._0))
						}),
					_1: _elm_lang$core$Maybe$Nothing
				};
			default:
				var _p1 = model.initialValue;
				if (_p1.ctor === 'Just') {
					return _elm_lang$core$String$isEmpty(model.name) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Maybe$Nothing} : {
						ctor: '_Tuple2',
						_0: model,
...
var _user$project$AddAccount$Model = F2(
	function (a, b) {
		return {name: a, initialValue: b};
	});
var _user$project$AddAccount$init = A2(
	_user$project$AddAccount$Model,
	'',
	_elm_lang$core$Maybe$Just(0));
var _user$project$AddAccount$Submit = {ctor: 'Submit'};
var _user$project$AddAccount$UpdateValue = function (a) {
	return {ctor: 'UpdateValue', _0: a};
};
var _user$project$AddAccount$UpdateName = function (a) {
	...
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				'accountname',
				'Name',
				_user$project$AddAccount$UpdateName,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Current account'),
				...
				'value',
				'Initial value',
				_user$project$AddAccount$UpdateValue,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(
						A2(
							_elm_lang$core$Maybe$withDefault,
							'',
							A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, model.initialValue))),
...
var _user$project$Kinvey$baseDataUrl = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://baas.kinvey.com/appdata/',
		A2(_elm_lang$core$Basics_ops['++'], _p1.appId, '/'));
};
var _user$project$Kinvey$baseUserUrl = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://baas.kinvey.com/user/',
		A2(_elm_lang$core$Basics_ops['++'], _p3.appId, '/'));
};
var _user$project$Kinvey$errorToString = function (e) {
	var _p4 = e;
	if (_p4.ctor === 'AuthError') {
		return A2(_elm_lang$core$Basics_ops['++'], 'Authentication error: ', _p4._0);
	} else {
		switch (_p4._0.ctor) {
			case 'Timeout':
				return 'Timeout';
			...
			case 'UnexpectedPayload':
				return A2(_elm_lang$core$Basics_ops['++'], 'Unexpected payload: ', _p4._0._0);
			default:
				return _p4._0._1;
		}
	}
};
var _user$project$Kinvey$contentType = {ctor: '_Tuple2', _0: 'Content-Type', _1: 'application/json'};
var _user$project$Kinvey$apiVersion = {ctor: '_Tuple2', _0: 'X-Kinvey-Api-Version', _1: '3'};
var _user$project$Kinvey$Auth = F2(
	function (a, b) {
		return {appId: a, appSecret: b};
	});
var _user$project$Kinvey$Session = F2(
	function (a, b) {
		return {token: a, id: b};
	});
var _user$project$Kinvey$HttpError = function (a) {
	return {ctor: 'HttpError', _0: a};
};
var _user$project$Kinvey$getUserData = F3(
	function (auth, session, decoder) {
		return A2(
			_elm_lang$core$Task$mapError,
			_user$project$Kinvey$HttpError,
			A2(
				_evancz$elm_http$Http$fromJson,
				decoder,
				A2(
					...
					_evancz$elm_http$Http$defaultSettings,
					{
						...
						headers: _elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'Authorization', _1: session.token},
								_user$project$Kinvey$apiVersion
							]),
						url: A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Kinvey$baseUserUrl(auth),
							'_me'),
						body: _evancz$elm_http$Http$empty
					})));
	});
var _user$project$Kinvey$setUserData = F3(
	function (auth, session, fields) {
		return A2(
			_elm_lang$core$Task$mapError,
			_user$project$Kinvey$HttpError,
			A2(
				...
				A2(
					...
					_evancz$elm_http$Http$defaultSettings,
					{
						...
						headers: _elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'Authorization', _1: session.token},
								_user$project$Kinvey$contentType,
								_user$project$Kinvey$apiVersion
							]),
						url: A2(
							_elm_lang$core$Basics_ops['++'],
...
var _user$project$Kinvey$createData = F5(
	function (auth, session, collection, decoder, data) {
		return A2(
			_elm_lang$core$Task$mapError,
			_user$project$Kinvey$HttpError,
			A2(
				...
				A2(
					...
					_evancz$elm_http$Http$defaultSettings,
					{
						...
						url: A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Kinvey$baseDataUrl(auth),
							collection),
						body: _evancz$elm_http$Http$string(
							A2(_elm_lang$core$Json_Encode$encode, 0, data))
					})));
	});
var _user$project$Kinvey$createDataSimple = F3(
	function (auth, session, collection) {
		return A4(
			_user$project$Kinvey$createData,
			auth,
			session,
			collection,
			_elm_lang$core$Json_Decode$succeed(
...
var _user$project$Kinvey$getData = F5(
	function (auth, session, collection, sortfield, decoder) {
		return A2(
			_elm_lang$core$Task$mapError,
			_user$project$Kinvey$HttpError,
			A2(
									...
									switch (_p5.ctor) {
										...
										case 'ReverseSort':
											return A2(
												_elm_lang$core$Basics_ops['++'],
												'/?query={}&sort={\"',
												A2(_elm_lang$core$Basics_ops['++'], _p5._0, '\": -1}'));
										default:
											return A2(_elm_lang$core$Basics_ops['++'], '/?query={}&sort=', _p5._0);
									}
								}())),
						body: _evancz$elm_http$Http$empty
					})));
	});
var _user$project$Kinvey$AuthError = function (a) {
	return {ctor: 'AuthError', _0: a};
};
var _user$project$Kinvey$getAuthToken = function (_p6) {
	var _p7 = _p6;
	return _elm_lang$core$Task$fromResult(
		A2(
			_elm_lang$core$Result$formatError,
			_user$project$Kinvey$AuthError,
			A2(
				...
				_truqu$elm_base64$Base64$encode(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_p7.appId,
						A2(_elm_lang$core$Basics_ops['++'], ':', _p7.appSecret))))));
};
var _user$project$Kinvey$signup = F4(
	function (auth, username, password, fields) {
		return A2(
			_elm_lang$core$Task$andThen,
			_user$project$Kinvey$getAuthToken(auth),
			function (token) {
				return A2(
					_elm_lang$core$Task$mapError,
					_user$project$Kinvey$HttpError,
					A2(
						...
						A2(
							...
							_evancz$elm_http$Http$defaultSettings,
							{
								...
								headers: _elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'Authorization', _1: token},
										_user$project$Kinvey$contentType,
										_user$project$Kinvey$apiVersion
									]),
								url: _user$project$Kinvey$baseUserUrl(auth),
								body: _evancz$elm_http$Http$string(
									A2(
										_elm_lang$core$Json_Encode$encode,
										0,
											...
											A2(
												...
												A2(
													...
													function (_p8) {
														...
														var _p10 = _p9._0;
														return _elm_lang$core$Basics$not(
															_elm_lang$core$Native_Utils.eq(_p10, 'username') || _elm_lang$core$Native_Utils.eq(_p10, 'password'));
													},
													fields)))))
							})));
			});
	});
var _user$project$Kinvey$login = F4(
	function (auth, email, password, decoder) {
		return A2(
			_elm_lang$core$Task$andThen,
			_user$project$Kinvey$getAuthToken(auth),
			function (token) {
									...
									function (id) {
										return A2(
											...
											F2(
												...
												{
													token: A2(_elm_lang$core$Basics_ops['++'], 'Kinvey ', token),
													id: id
												}),
											decoder);
									});
...
var _user$project$Kinvey$Sort = function (a) {
	return {ctor: 'Sort', _0: a};
};
var _user$project$Kinvey$ReverseSort = function (a) {
	return {ctor: 'ReverseSort', _0: a};
};
var _user$project$Kinvey$NoSort = {ctor: 'NoSort'};

var _user$project$MyKinvey$auth = {appId: 'kid_ZkL79b5Kbb', appSecret: 'aa5f8ad01ed7447fbb9a65fbd8b1f901'};
var _user$project$MyKinvey$signup = _user$project$Kinvey$signup(_user$project$MyKinvey$auth);
var _user$project$MyKinvey$login = F2(
	function (username, password) {
		return A2(
			...
			A4(
				_user$project$Kinvey$login,
				_user$project$MyKinvey$auth,
				username,
				password,
				_elm_lang$core$Json_Decode$succeed(
					{ctor: '_Tuple0'})));
	});
var _user$project$MyKinvey$getUserData = _user$project$Kinvey$getUserData(_user$project$MyKinvey$auth);
var _user$project$MyKinvey$setUserData = _user$project$Kinvey$setUserData(_user$project$MyKinvey$auth);
var _user$project$MyKinvey$createData = _user$project$Kinvey$createData(_user$project$MyKinvey$auth);
var _user$project$MyKinvey$createDataSimple = _user$project$Kinvey$createDataSimple(_user$project$MyKinvey$auth);
var _user$project$MyKinvey$getData = _user$project$Kinvey$getData(_user$project$MyKinvey$auth);

var _user$project$AddButton$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {componentModel: a, session: b, table: c, decoder: d, title: e, objects: f, componentInit: g, componentUpdate: h, componentView: i};
	});
var _user$project$AddButton$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$AddButton$Fetch = function (a) {
	return {ctor: 'Fetch', _0: a};
};
var _user$project$AddButton$init = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1.table;
	var _p3 = _p1.session;
	var _p2 = _p1.decoder;
	return {
		ctor: '_Tuple2',
		_0: {componentModel: _elm_lang$core$Maybe$Nothing, session: _p3, table: _p4, decoder: _p2, title: _p1.title, objects: _elm_lang$core$Maybe$Nothing, componentInit: _p1.init, componentUpdate: _p1.update, componentView: _p1.view},
		_1: A3(
			_elm_lang$core$Task$perform,
			_user$project$AddButton$Error,
			_user$project$AddButton$Fetch,
			A4(_user$project$MyKinvey$getData, _p3, _p4, _user$project$Kinvey$NoSort, _p2))
	};
};
var _user$project$AddButton$Created = function (a) {
	return {ctor: 'Created', _0: a};
};
var _user$project$AddButton$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'Open':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							componentModel: _elm_lang$core$Maybe$Just(model.componentInit)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
				};
			case 'Close':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{componentModel: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
				};
			case 'Created':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{objects: objects, componentModel: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: A2(_elm_lang$core$Maybe$map, _elm_lang$core$Result$Ok, objects)
				};
			case 'Fetch':
				var _p6 = _p5._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							objects: _elm_lang$core$Maybe$Just(_p6)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					...
					if (_p7._0._1.ctor === 'Nothing') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									componentModel: _elm_lang$core$Maybe$Just(_p7._0._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none,
							_2: _elm_lang$core$Maybe$Nothing
						};
						...
						return {
							...
							_1: A3(
								_elm_lang$core$Task$perform,
								_user$project$AddButton$Error,
								_user$project$AddButton$Created,
								A4(_user$project$MyKinvey$createData, model.session, model.table, model.decoder, _p7._0._1._0)),
							_2: _elm_lang$core$Maybe$Nothing
						};
					}
				} else {
...
var _user$project$AddButton$ComponentMsg = function (a) {
	return {ctor: 'ComponentMsg', _0: a};
};
var _user$project$AddButton$Close = {ctor: 'Close'};
var _user$project$AddButton$Open = {ctor: 'Open'};
var _user$project$AddButton$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Lib$successButton,
				model.title,
				A2(
					_elm_lang$core$Maybe$map,
					_elm_lang$core$Basics$always(_user$project$AddButton$Open),
					model.objects)),
				A5(_user$project$Lib$viewDialog, model.title, model.componentModel, _user$project$AddButton$Close, _user$project$AddButton$ComponentMsg, model.componentView)
			]));
};
...
var _user$project$AddTransaction$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {object: a, value: b, valueString: c, datePicker: d, date: e, account: f, accounts: g, $for: h, contacts: i, income: j};
									};
								};
							};
						};
...
var _user$project$AddTransaction$Submit = {ctor: 'Submit'};
var _user$project$AddTransaction$AddContact = function (a) {
	return {ctor: 'AddContact', _0: a};
};
var _user$project$AddTransaction$UpdateShare = F2(
	function (a, b) {
		return {ctor: 'UpdateShare', _0: a, _1: b};
	});
var _user$project$AddTransaction$UpdateAccount = function (a) {
	return {ctor: 'UpdateAccount', _0: a};
};
var _user$project$AddTransaction$UpdateDate = function (a) {
	return {ctor: 'UpdateDate', _0: a};
};
var _user$project$AddTransaction$init = F3(
	function (income, accounts, contacts) {
		var _p0 = _Bogdanp$elm_datepicker$DatePicker$init(
			_elm_lang$core$Native_Utils.update(
				_Bogdanp$elm_datepicker$DatePicker$defaultSettings,
				{
					placeholder: '1 Jan 1970',
					dateFormatter: _mgold$elm_date_format$Date_Format$format('%e %b %Y'),
					firstDayOfWeek: _elm_lang$core$Date$Mon,
					inputClassList: _elm_lang$core$Native_List.fromArray(
						[
		...
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{
				...
				account: _elm_lang$core$List$head(accounts),
				accounts: accounts,
				$for: _elm_lang$core$Native_List.fromArray(
					[]),
				contacts: contacts,
				income: income
			},
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$AddTransaction$UpdateDate, dateCmd)
				]));
	});
var _user$project$AddTransaction$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UpdateObject':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							object: A2(_elm_lang$core$String$left, 50, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
				};
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							value: A2(
								...
								_Fresheyeball$elm_restrict_number$Positive$fromNum),
							valueString: _p2
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
			...
			case 'UpdateDate':
				var _p3 = A2(_Bogdanp$elm_datepicker$DatePicker$update, _p1._0, model.datePicker);
				var dateModel = _p3._0;
				var dateCmd = _p3._1;
				var date = _p3._2;
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							datePicker: dateModel,
							date: _elm_lang$core$Maybe$oneOf(
								_elm_lang$core$Native_List.fromArray(
									[date, model.date]))
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$AddTransaction$UpdateDate, dateCmd),
					_2: _elm_lang$core$Maybe$Nothing
				};
			case 'UpdateAccount':
				return {
			...
			case 'AddContact':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							$for: A2(_elm_lang$core$Basics_ops['++'], model.$for, newContacts),
							contacts: remains
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
			...
			default:
				var _p7 = {ctor: '_Tuple3', _0: model.value, _1: model.date, _2: model.account};
				if ((((_p7.ctor === '_Tuple3') && (_p7._0.ctor === 'Just')) && (_p7._1.ctor === 'Just')) && (_p7._2.ctor === 'Just')) {
					return _elm_lang$core$String$isEmpty(model.object) ? {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing} : {
						ctor: '_Tuple3',
						_0: model,
						_1: _elm_lang$core$Platform_Cmd$none,
						_2: _elm_lang$core$Maybe$Just(
							_elm_lang$core$Json_Encode$object(
								_elm_lang$core$Native_List.fromArray(
									[
										...
										ctor: '_Tuple2',
										_0: 'object',
										_1: _elm_lang$core$Json_Encode$string(model.object)
									},
										{
										ctor: '_Tuple2',
										_0: 'value',
										_1: _elm_lang$core$Json_Encode$float(
											(model.income ? _elm_lang$core$Basics$identity : F2(
												function (x, y) {
													return x - y;
												})(0))(
												_Fresheyeball$elm_restrict_number$Positive$toNum(_p7._0._0)))
									},
										{
										ctor: '_Tuple2',
										_0: 'date',
										_1: _elm_lang$core$Json_Encode$string(
											_mgold$elm_date_format$Date_Format$formatISO8601(_p7._1._0))
									},
										{
										ctor: '_Tuple2',
										_0: 'account',
										_1: _elm_lang$core$Json_Encode$string(_p7._2._0.id)
									}
									])))
					};
				} else {
...
var _user$project$AddTransaction$UpdateValue = function (a) {
	return {ctor: 'UpdateValue', _0: a};
};
var _user$project$AddTransaction$UpdateObject = function (a) {
	...
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				'object',
				'Object',
				_user$project$AddTransaction$UpdateObject,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Groceries'),
						_elm_lang$html$Html_Attributes$value(model.object),
						_elm_lang$html$Html_Attributes$required(true)
					])),
				A4(
				_user$project$Lib$inputGr,
				'value',
				'Value',
				_user$project$AddTransaction$UpdateValue,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('23.33'),
						_elm_lang$html$Html_Attributes$value(model.valueString),
						_elm_lang$html$Html_Attributes$type$('number'),
						_elm_lang$html$Html_Attributes$min('0.01'),
						_elm_lang$html$Html_Attributes$step('0.01'),
						_elm_lang$html$Html_Attributes$required(true)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$for('date')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						A2(
						_elm_lang$html$Html_App$map,
						_user$project$AddTransaction$UpdateDate,
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				(_elm_lang$core$List$isEmpty(model.contacts) && _elm_lang$core$List$isEmpty(model.$for)) ? _elm_lang$core$Native_List.fromArray(
					[]) : A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
						[
							A6(
							_user$project$Lib$selector,
							'contact',
							'Share with',
							A2(
								_elm_lang$core$List_ops['::'],
								{
									...
									id: _elm_lang$core$Basics$toString(
										_elm_lang$core$List$length(model.contacts))
								},
								model.contacts),
							_user$project$AddTransaction$AddContact,
							_elm_lang$core$Native_List.fromArray(
								[]),
							false)
						]),
							...
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(contact.name)
											])),
										A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(_elm_lang$core$Basics_ops['++'], 'percent-', contact.id)),
														_elm_lang$html$Html_Attributes$class('sr-only')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text('Their share in percents')
													])),
												A2(
												_elm_lang$html$Html$input,
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(_elm_lang$core$Basics_ops['++'], 'percent-', contact.id)),
														_elm_lang$html$Html_Attributes$class('form-control'),
														_elm_lang$html$Html_Attributes$placeholder('50%'),
														_elm_lang$html$Html_Attributes$type$('text')
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$for(
														A2(_elm_lang$core$Basics_ops['++'], 'exact-share-', contact.id)),
														_elm_lang$html$Html_Attributes$class('sr-only')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text('Their exact share')
													])),
												A2(
												_elm_lang$html$Html$input,
												_elm_lang$core$Native_List.fromArray(
...
var _user$project$AddTransaction$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A3(
				_user$project$AddTransaction$init,
				true,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
			...
			update: F2(
				function (msg, model) {
					var _p8 = A2(_user$project$AddTransaction$update, msg, model);
					var model = _p8._0;
					var cmd = _p8._1;
					return {ctor: '_Tuple2', _0: model, _1: cmd};
				}),
			view: _user$project$AddTransaction$view,
...
var _user$project$LoggedIn$updateStandard = function (model) {
	return _elm_lang$core$Maybe$Just(
		{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
};
var _user$project$LoggedIn$filterTransactions = function (selected) {
	var _p0 = selected;
	if (_p0.ctor === 'Nothing') {
...
var _user$project$LoggedIn$accountValue = function (account) {
	return function (_p2) {
		return A3(
			_elm_lang$core$List$foldl,
			function (_p3) {
			...
			account.value,
			A2(
				_user$project$LoggedIn$filterTransactions,
				_elm_lang$core$Maybe$Just(account),
				_p2));
	};
};
var _user$project$LoggedIn$viewTransaction = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_p5.object)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_mgold$elm_date_format$Date_Format$format, '%e %b %Y', _p5.date))
					]))
			]));
};
var _user$project$LoggedIn$transactionTable = 'transactions';
var _user$project$LoggedIn$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {session: a, transactions: b, addTransaction: c, accounts: d, selectedAccount: e, selectedAccountValue: f, addAccount: g, contacts: h, addContact: i, recentError: j};
									};
								};
							};
						};
...
var _user$project$LoggedIn$init = function (session) {
	var _p6 = _user$project$AddButton$init(
		{session: session, table: 'accounts', decoder: _user$project$Lib$decodeAccount, title: 'Create a new account', init: _user$project$AddAccount$init, update: _user$project$AddAccount$update, view: _user$project$AddAccount$view});
	var addAccountModel = _p6._0;
	var addAccountCmd = _p6._1;
	var _p7 = _user$project$AddButton$init(
		{session: session, table: 'contacts', decoder: _user$project$Lib$decodeContact, title: 'Add a new contact', init: _user$project$AddContact$init, update: _user$project$AddContact$update, view: _user$project$AddContact$view});
	var addContactModel = _p7._0;
	var addContactCmd = _p7._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{session: session, transactions: _elm_lang$core$Maybe$Nothing, addTransaction: _elm_lang$core$Maybe$Nothing, accounts: _elm_lang$core$Maybe$Nothing, selectedAccount: _elm_lang$core$Maybe$Nothing, selectedAccountValue: _elm_lang$core$Maybe$Nothing, addAccount: addAccountModel, contacts: _elm_lang$core$Maybe$Nothing, addContact: addContactModel, recentError: ''},
		_elm_lang$core$Native_List.fromArray(
			[
				A3(
				_elm_lang$core$Task$perform,
				_user$project$LoggedIn$Error,
				_user$project$LoggedIn$FetchTransactions,
				A4(
					_user$project$MyKinvey$getData,
					session,
					_user$project$LoggedIn$transactionTable,
					_user$project$Kinvey$ReverseSort('date'),
					_user$project$Lib$decodeTransaction)),
				A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddAccountMsg, addAccountCmd),
				A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddContactMsg, addContactCmd)
			]));
};
var _user$project$LoggedIn$CreatedTransaction = function (a) {
	return {ctor: 'CreatedTransaction', _0: a};
};
var _user$project$LoggedIn$CloseAddTransaction = {ctor: 'CloseAddTransaction'};
var _user$project$LoggedIn$OpenAddTransaction = function (a) {
	return {ctor: 'OpenAddTransaction', _0: a};
};
...
var _user$project$LoggedIn$view = function (model) {
	var existAccount = A2(
		...
		A2(
			...
			model.accounts));
	var _p8 = {ctor: '_Tuple2', _0: model.transactions, _1: model.accounts};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Lib$successButton,
					'Add a new expense',
					existAccount ? _elm_lang$core$Maybe$Just(
						_user$project$LoggedIn$OpenAddTransaction(false)) : _elm_lang$core$Maybe$Nothing),
					_elm_lang$html$Html$text(' '),
					A2(
					_user$project$Lib$successButton,
					'Add a new income',
					existAccount ? _elm_lang$core$Maybe$Just(
						_user$project$LoggedIn$OpenAddTransaction(true)) : _elm_lang$core$Maybe$Nothing),
					_elm_lang$html$Html$text(' '),
					A2(
					_elm_lang$html$Html_App$map,
					_user$project$LoggedIn$AddAccountMsg,
					_user$project$AddButton$view(model.addAccount)),
					_elm_lang$html$Html$text(' '),
					A2(
					_elm_lang$html$Html_App$map,
					_user$project$LoggedIn$AddContactMsg,
					_user$project$AddButton$view(model.addContact)),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('text-danger')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(model.recentError)
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('List of recent transactions')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								...
								_p8._1._0),
							_user$project$LoggedIn$UpdateSelectedAccount,
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'form-inline', _1: true},
									{ctor: '_Tuple2', _0: 'col-md-4', _1: true}
								]),
							false),
							A2(
							_elm_lang$html$Html$div,
					...
					A2(
						...
						A2(
							...
							A2(_user$project$LoggedIn$filterTransactions, model.selectedAccount, _p8._0._0)))),
					A5(_user$project$Lib$viewDialog, 'Add a new transaction', model.addTransaction, _user$project$LoggedIn$CloseAddTransaction, _user$project$LoggedIn$AddTransactionMsg, _user$project$AddTransaction$view)
				]));
	} else {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('text-info')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$LoggedIn$update = F2(
	function (msg, model) {
		var _p10 = msg;
		switch (_p10.ctor) {
			case 'AddTransactionMsg':
				var _p11 = A2(
					_elm_lang$core$Maybe$map,
					_user$project$AddTransaction$update(_p10._0),
					model.addTransaction);
				if (_p11.ctor === 'Just') {
					if (_p11._0._2.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										addTransaction: _elm_lang$core$Maybe$Just(_p11._0._0)
									}),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddTransactionMsg, _p11._0._1)
							});
					} else {
						return _elm_lang$core$Maybe$Just(
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Task$perform,
										_user$project$LoggedIn$Error,
										_user$project$LoggedIn$CreatedTransaction,
										A4(_user$project$MyKinvey$createData, model.session, _user$project$LoggedIn$transactionTable, _user$project$Lib$decodeTransaction, _p11._0._2._0)),
										A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddTransactionMsg, _p11._0._1)
									])));
					}
				} else {
					...
					return _elm_lang$core$Maybe$Just(
						{
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									addTransaction: _elm_lang$core$Maybe$Just(addTransaction)
								}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddTransactionMsg, cmd)
						});
				} else {
					return _user$project$LoggedIn$updateStandard(model);
				}
			case 'CloseAddTransaction':
				return _user$project$LoggedIn$updateStandard(
					_elm_lang$core$Native_Utils.update(
						model,
						{addTransaction: _elm_lang$core$Maybe$Nothing}));
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							transactions: A2(
								...
								model.transactions),
							addTransaction: _elm_lang$core$Maybe$Nothing,
							selectedAccountValue: function () {
								var _p14 = {ctor: '_Tuple2', _0: model.selectedAccount, _1: model.selectedAccountValue};
								if (((_p14.ctor === '_Tuple2') && (_p14._0.ctor === 'Just')) && (_p14._1.ctor === 'Just')) {
									return _elm_lang$core$Native_Utils.eq(_p15.accountId, _p14._0._0.id) ? _elm_lang$core$Maybe$Just(_p14._1._0 + _p15.value) : model.selectedAccountValue;
								} else {
									return model.selectedAccountValue;
								}
							}()
						}));
			case 'FetchTransactions':
				return _user$project$LoggedIn$updateStandard(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							transactions: _elm_lang$core$Maybe$Just(_p10._0)
						}));
			case 'AddAccountMsg':
				var _p16 = A2(_user$project$AddButton$update, _p10._0, model.addAccount);
				var addAccount = _p16._0;
				var cmd = _p16._1;
				var ret = _p16._2;
				var _p17 = ret;
					...
					return _elm_lang$core$Maybe$Just(
						{
							...
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddAccountMsg, cmd)
						});
				} else {
					if (_p17._0.ctor === 'Ok') {
						return _elm_lang$core$Maybe$Just(
							{
								...
								_0: _elm_lang$core$Native_Utils.update(
									...
									{
										addAccount: addAccount,
										accounts: _elm_lang$core$Maybe$Just(_p17._0._0)
									}),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddAccountMsg, cmd)
							});
					} else {
						if (((_p17._0._0.ctor === 'HttpError') && (_p17._0._0._0.ctor === 'BadResponse')) && (_p17._0._0._0._0 === 401)) {
							return _elm_lang$core$Maybe$Nothing;
						} else {
							return _elm_lang$core$Maybe$Just(
								{
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											addAccount: addAccount,
											recentError: _user$project$Kinvey$errorToString(_p17._0._0)
										}),
									_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddAccountMsg, cmd)
								});
						}
			...
			case 'AddContactMsg':
				var _p19 = A2(_user$project$AddButton$update, _p10._0, model.addContact);
				var addContact = _p19._0;
				var cmd = _p19._1;
				var ret = _p19._2;
				var _p20 = ret;
					...
					return _elm_lang$core$Maybe$Just(
						{
							...
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddContactMsg, cmd)
						});
				} else {
					if (_p20._0.ctor === 'Ok') {
						return _elm_lang$core$Maybe$Just(
							{
								...
								_0: _elm_lang$core$Native_Utils.update(
									...
									{
										addContact: addContact,
										contacts: _elm_lang$core$Maybe$Just(_p20._0._0)
									}),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddContactMsg, cmd)
							});
					} else {
						if (((_p20._0._0.ctor === 'HttpError') && (_p20._0._0._0.ctor === 'BadResponse')) && (_p20._0._0._0._0 === 401)) {
							return _elm_lang$core$Maybe$Nothing;
						} else {
							return _elm_lang$core$Maybe$Just(
								{
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											addContact: addContact,
											recentError: _user$project$Kinvey$errorToString(_p20._0._0)
										}),
									_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$LoggedIn$AddContactMsg, cmd)
								});
						}
			...
			default:
				var _p22 = _p10._0;
				var _p21 = _p22;
				if (((_p21.ctor === 'HttpError') && (_p21._0.ctor === 'BadResponse')) && (_p21._0._0 === 401)) {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					return _user$project$LoggedIn$updateStandard(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								recentError: _user$project$Kinvey$errorToString(_p22)
							}));
				}
		}
	});
...
var _user$project$Login$Model = F3(
	function (a, b, c) {
		return {username: a, password: b, recentError: c};
	});
var _user$project$Login$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A3(_user$project$Login$Model, '', '', ''),
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Login$Success = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Please login')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onInput(_user$project$Login$Username),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onInput(_user$project$Login$Password),
...
var _user$project$Login$NewSession = function (a) {
	return {ctor: 'NewSession', _0: a};
};
var _user$project$Login$Update = function (a) {
...
var _user$project$Login$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Username':
				return _user$project$Login$Update(
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'Login':
				return _user$project$Login$Update(
					{
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Debug$log, 'Login', model),
						_1: A3(
							_elm_lang$core$Task$perform,
							_user$project$Login$Error,
							_user$project$Login$Success,
							A2(_user$project$MyKinvey$login, model.username, model.password))
					});
			case 'Error':
				var _p2 = _p0._0;
				return _user$project$Login$Update(
					{
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								recentError: function () {
									var _p1 = _p2;
									if (((_p1.ctor === 'HttpError') && (_p1._0.ctor === 'BadResponse')) && (_p1._0._0 === 401)) {
										return 'Authentication failure';
									} else {
										return _user$project$Kinvey$errorToString(_p2);
									}
								}()
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				return _user$project$Login$NewSession(_p0._0);
		}
	});
...
var _user$project$Main$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {token: v.token, id: v.id};
	});
var _user$project$Main$LoggedInModel = function (a) {
	return {ctor: 'LoggedInModel', _0: a};
};
var _user$project$Main$LoginModel = function (a) {
...
var _user$project$Main$init = function (savedSession) {
	var _p0 = savedSession;
	if (_p0.ctor === 'Nothing') {
		var _p1 = _user$project$Login$init;
		var model = _p1._0;
		var cmd = _p1._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$Main$LoginModel(model),
			_elm_lang$core$Native_List.fromArray(
				[cmd]));
	} else {
		var _p3 = _p0._0;
		var _p2 = _user$project$LoggedIn$init(_p3);
		var model = _p2._0;
		var cmd = _p2._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$Main$LoggedInModel(model),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$LoggedInMsg, cmd),
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		do {
			if (_p4.ctor === '_Tuple2') {
				if (_p4._1.ctor === 'LoginModel') {
					if (_p4._0.ctor === 'LoginMsg') {
						var _p5 = A2(_user$project$Login$update, _p4._0._0, _p4._1._0);
						if (_p5.ctor === 'Update') {
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$LoginModel(_p5._0._0),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$LoginMsg, _p5._0._1)
							};
						} else {
					...
					if (_p4._0.ctor === 'LoggedInMsg') {
						var _p6 = A2(_user$project$LoggedIn$update, _p4._0._0, _p4._1._0);
						if (_p6.ctor === 'Nothing') {
							return _user$project$Main$init(_elm_lang$core$Maybe$Nothing);
						} else {
							return {
								ctor: '_Tuple2',
								_0: _user$project$Main$LoggedInModel(_p6._0._0),
								_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$LoggedInMsg, _p6._0._1)
							};
						}
					} else {
						break _v1_2;
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Keeping track of my spendings')
					])),
				function () {
				var _p7 = model;
				if (_p7.ctor === 'LoginModel') {
					return A2(
						_elm_lang$html$Html_App$map,
						_user$project$Main$LoginMsg,
						_user$project$Login$view(_p7._0));
				} else {
					return A2(
						_elm_lang$html$Html_App$map,
						_user$project$Main$LoggedInMsg,
						_user$project$LoggedIn$view(_p7._0));
				}
			}()
			]));
};
